...
enum TypeEnum Type::getType(){return t;}

Program::Program(){programName = "";} //dummy
...
int Program::getNumStates(){return states->size();}
int Program::getNumVarDecls(){return decls->getNumVarDecls();}
...
State::State(Transitions* t) : tran(t){ assert(tran != NULL);}
...
int VariableUse::getNumVarUses(){return 1;}
